...
module Api
  module V1
    class RegistrationsController < Api::ApiBase
      ...
      def ensure_params_exist
        return unless params[:user_registration].blank?
      ...
      def sign_up_params
        params.require(:user_registration).permit(:name, :email, :password, :password_confirmation)
      end
