...
module Admin
  module Suppliers
    class TextMessagesController < BaseController
      before_action :set_admin_suppliers_text_message, only: %i[show edit update destroy]
      ...
      def destroy
        ...
        respond_to do |format|
          format.html do
            redirect_to admin_suppliers_text_messages_url, notice: 'Text message was successfully destroyed.'
          end
